...
template <bool isRequest, typename DynamicBuffer>
void message<isRequest, DynamicBuffer>::set(http::authorization::methods const& m) {
...
template <bool isRequest, typename DynamicBuffer>
bool message<isRequest, DynamicBuffer>::is_content_type(std::string_view type) const {
...
template <bool isRequest, typename DynamicBuffer>
void message<isRequest, DynamicBuffer>::content(asio::const_buffer buffer) {
